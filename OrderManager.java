...
public class OrderManager {
    private static final String ORDER_FILE_PATH = "C:\\Users\\Reynold\\Documents\\NetBeansProjects\\Assignment\\src\\assignment\\ReynoldOrder.txt";
    private static final String SUPPLIER_FILE_PATH = "C:\\Users\\Reynold\\Documents\\NetBeansProjects\\Assignment\\src\\assignment\\ReynoldSupplier.txt";
    ...
    public void displayOrders() {
        ...
        System.out.println("----------------------------------------------------");
        System.out.printf("%-10s | %-10s | %-15s | %-15s | %-8s | %-8s | %-10s%n", 
                          "Order ID", "Date", "Supplier", "Product", "Price", "Quantity", "Total");
        System.out.println("----------------------------------------------------");
    ...
    public void createOrder() {
        try {
            ...
            // Write to order file
            String orderLine = String.format("%s|%s|%s|%s|%.2f|%d|%.2f",
                    orderId, date, selectedSupplier[1], productName, price, quantity, totalPrice);
